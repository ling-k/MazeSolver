...
# Create the node
cmd_vel_pub = rospy.Publisher('/robot1/cmd_vel', Twist, queue_size = 1) # to move the robot
scan_sub = rospy.Subscriber('robot1/scan', LaserScan, scan_callback)   # to read the laser scanner
find_sub = rospy.Subscriber('robot1/find_robot2', Twist, find_callback)   # to read the find status
...
while not rospy.is_shutdown():
    ...
    if(find_flag == False and center_flag == True):
